...
export default function NewItem({ onAddItem }) {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(item);
    alert(`added itm: ${name}, quantity: ${quantity}, category: ${category}`);
      ...
      >
        ...
        <div className="mb-2">
          <input
            ...
            required
            className="w-full mt-1 border-2 bg-white border-gray-300 p-2 rounded-lg font-sans"
            value={name}
        ...
        <div className="flex justify-between items-center">
          ...
          {}
          <select
            className="ml-1 border-2 bg-white border-gray-300 p-2 rounded-lg font-sans"
            value={category}
